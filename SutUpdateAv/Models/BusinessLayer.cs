...
namespace SutUpdateAv.Models
{
    public sealed class BusinessLayer
    {
        ...
        private static readonly BusinessLayer instance = new BusinessLayer(UserSetting.SutConnectionString, UserSetting.SutProvider);
        ...
        public BusinessLayer(string conn, string prov)
        {
            sLayer = new SutLayer(conn, prov);
        }
